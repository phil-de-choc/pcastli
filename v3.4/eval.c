...
data eval_math_oper_assign(node* to_eval)
{
   ...
   case NT_VARIABLE:
      ...
      if (!destination)
      {
         ...
         if (!clos_set_stack[set_stack_size-1]->clos_array)
            fatal_error("Error: Lack of memory in eval_math_oper.");
      ...
      if (source.name)
      {
         ...
         if (!destination->name)
            fatal_error("Error: Lack of memory in eval_math_oper_assign for name.");
   ...
   case NT_MATH_OPER:
      ...
      {
         *(data*)from_eval1.value.genptr = from_eval2;
   ...
   case NT_SUBSCRIPT:
      ...
      if (!from_resolve)
      {
         ...
         {
            free_data(from_eval2);
            yyerror("Error: Expecting an array, a list, a string or memory before subscript.");
            return retval;
         }
         ...
         {
            if (from_eval2.ti.dtype != DT_STRING && from_eval2.ti.dtype != DT_CHAR)
            {
               yyerror("Error: Can't assign non string or char to string.");
               abort_called = 1;
               free_data(from_eval2);
               return retval;
            }
            ...
            if (from_eval2.ti.dtype == DT_STRING)
            {
               ...
               if (!retval.value.str.tab)
                  fatal_error("Error: Lack of memory in assign for string data.");
            ...
            {
               from_resolve->value.str.tab[llindex] = from_eval2.value.cnum;
               retval = from_eval2;
            }
         }
...
data eval_math_oper(node* to_eval)
{
   ...
   case '-':
      ...
      else fatal_error("Error: Wrong child number "
            "for a \'-\' in eval_math_oper.");

   case '+':
      if (to_eval->nb_children != 2)
         fatal_error("Error: Wrong child number "
            "for a \'+\' in eval_math_oper.");
      from_eval1 = eval(to_eval->childset[0]);
      from_eval2 = eval(to_eval->childset[1]);
      if (from_eval1.ti.dtype < DT_CHAR || from_eval1.ti.dtype > DT_LONG_DOUBLE ||
   ...
   case '%':
      ...
      from_eval1 = eval(to_eval->childset[0]);
      from_eval2 = eval(to_eval->childset[1]);
      if (from_eval1.ti.dtype < DT_CHAR || from_eval1.ti.dtype > DT_SIZE_T ||
         from_eval2.ti.dtype < DT_CHAR || from_eval2.ti.dtype > DT_SIZE_T ||
         from_eval1.ti.nderef > 0 || from_eval2.ti.nderef > 0)
      {
         yyerror("Type error for operator \'%\'.");
         abort_called = 1;
      ...
      case DT_SIZE_T:
         ...
         {
         case DT_CHAR:
            retval.value.stnum = from_eval1.value.stnum % from_eval2.value.cnum;
            break;
         case DT_S_CHAR:
            retval.value.stnum = from_eval1.value.stnum % from_eval2.value.scnum;
            break;
         case DT_U_CHAR:
         case DT_BYTE:
            retval.value.stnum = from_eval1.value.stnum % from_eval2.value.ucnum;
            break;
         case DT_SHORT:
            retval.value.stnum = from_eval1.value.stnum % from_eval2.value.shnum;
            break;
         case DT_U_SHORT:
            retval.value.stnum = from_eval1.value.stnum % from_eval2.value.ushnum;
            break;
         case DT_INT:
            retval.value.stnum = from_eval1.value.stnum % from_eval2.value.inum;
            break;
         case DT_U_INT:
            retval.value.stnum = from_eval1.value.stnum % from_eval2.value.uinum;
            break;
         case DT_LONG:
            retval.value.stnum = from_eval1.value.stnum % from_eval2.value.lnum;
            break;
         case DT_U_LONG:
            retval.value.stnum = from_eval1.value.stnum % from_eval2.value.ulnum;
            break;
         case DT_LONG_LONG:
            retval.value.stnum = from_eval1.value.stnum % from_eval2.value.llnum;
            break;
         case DT_U_LONG_LONG:
            retval.value.stnum = from_eval1.value.stnum % from_eval2.value.ullnum;
            break;
         case DT_SIZE_T:
            retval.value.stnum = from_eval1.value.stnum % from_eval2.value.stnum;
            break;
         default:
            break;
         }
      ...
      case DT_U_LONG_LONG:
         ...
         {
         case DT_CHAR:
            retval.value.ullnum = from_eval1.value.ullnum % from_eval2.value.cnum;
            break;
         case DT_S_CHAR:
            retval.value.ullnum = from_eval1.value.ullnum % from_eval2.value.scnum;
            break;
         case DT_U_CHAR:
         case DT_BYTE:
            retval.value.ullnum = from_eval1.value.ullnum % from_eval2.value.ucnum;
            break;
         case DT_SHORT:
            retval.value.ullnum = from_eval1.value.ullnum % from_eval2.value.shnum;
            break;
         case DT_U_SHORT:
            retval.value.ullnum = from_eval1.value.ullnum % from_eval2.value.ushnum;
            break;
         case DT_INT:
            retval.value.ullnum = from_eval1.value.ullnum % from_eval2.value.inum;
            break;
         case DT_U_INT:
            retval.value.ullnum = from_eval1.value.ullnum % from_eval2.value.uinum;
            break;
         case DT_LONG:
            retval.value.ullnum = from_eval1.value.ullnum % from_eval2.value.lnum;
            break;
         case DT_U_LONG:
            retval.value.ullnum = from_eval1.value.ullnum % from_eval2.value.ulnum;
            break;
         case DT_LONG_LONG:
            retval.value.ullnum = from_eval1.value.ullnum % from_eval2.value.llnum;
            break;
         case DT_U_LONG_LONG:
            retval.value.ullnum = from_eval1.value.ullnum % from_eval2.value.ullnum;
            break;
         case DT_SIZE_T:
            retval.value.ullnum = from_eval1.value.ullnum % from_eval2.value.stnum;
            break;
         default:
            break;
         }
      ...
      case DT_LONG_LONG:
         ...
         {
         case DT_CHAR:
            retval.value.llnum = from_eval1.value.llnum % from_eval2.value.cnum;
            break;
         case DT_S_CHAR:
            retval.value.llnum = from_eval1.value.llnum % from_eval2.value.scnum;
            break;
         case DT_U_CHAR:
         case DT_BYTE:
            retval.value.llnum = from_eval1.value.llnum % from_eval2.value.ucnum;
            break;
         case DT_SHORT:
            retval.value.llnum = from_eval1.value.llnum % from_eval2.value.shnum;
            break;
         case DT_U_SHORT:
            retval.value.llnum = from_eval1.value.llnum % from_eval2.value.ushnum;
            break;
         case DT_INT:
            retval.value.llnum = from_eval1.value.llnum % from_eval2.value.inum;
            break;
         case DT_U_INT:
            retval.value.llnum = from_eval1.value.llnum % from_eval2.value.uinum;
            break;
         case DT_LONG:
            retval.value.llnum = from_eval1.value.llnum % from_eval2.value.lnum;
            break;
         case DT_U_LONG:
            retval.value.llnum = from_eval1.value.llnum % from_eval2.value.ulnum;
            break;
         case DT_LONG_LONG:
            retval.value.llnum = from_eval1.value.llnum % from_eval2.value.llnum;
            break;
         case DT_U_LONG_LONG:
            retval.value.llnum = from_eval1.value.llnum % from_eval2.value.ullnum;
            break;
         case DT_SIZE_T:
            retval.value.llnum = from_eval1.value.llnum % from_eval2.value.stnum;
            break;
         default:
            break;
         }
      ...
      case DT_U_LONG:
         ...
         {
         case DT_CHAR:
            retval.value.ulnum = from_eval1.value.ulnum % from_eval2.value.cnum;
            break;
         case DT_S_CHAR:
            retval.value.ulnum = from_eval1.value.ulnum % from_eval2.value.scnum;
            break;
         case DT_U_CHAR:
         case DT_BYTE:
            retval.value.ulnum = from_eval1.value.ulnum % from_eval2.value.ucnum;
            break;
         case DT_SHORT:
            retval.value.ulnum = from_eval1.value.ulnum % from_eval2.value.shnum;
            break;
         case DT_U_SHORT:
            retval.value.ulnum = from_eval1.value.ulnum % from_eval2.value.ushnum;
            break;
         case DT_INT:
            retval.value.ulnum = from_eval1.value.ulnum % from_eval2.value.inum;
            break;
         case DT_U_INT:
            retval.value.ulnum = from_eval1.value.ulnum % from_eval2.value.uinum;
            break;
         case DT_LONG:
            retval.value.ulnum = from_eval1.value.ulnum % from_eval2.value.lnum;
            break;
         case DT_U_LONG:
            retval.value.ulnum = from_eval1.value.ulnum % from_eval2.value.ulnum;
            break;
         case DT_LONG_LONG:
            retval.value.ulnum = from_eval1.value.ulnum % from_eval2.value.llnum;
            break;
         case DT_U_LONG_LONG:
            retval.value.ulnum = from_eval1.value.ulnum % from_eval2.value.ullnum;
            break;
         case DT_SIZE_T:
            retval.value.ulnum = from_eval1.value.ulnum % from_eval2.value.stnum;
            break;
         default:
            break;
         }
      ...
      case DT_LONG:
         ...
         {
         case DT_CHAR:
            retval.value.lnum = from_eval1.value.lnum % from_eval2.value.cnum;
            break;
         case DT_S_CHAR:
            retval.value.lnum = from_eval1.value.lnum % from_eval2.value.scnum;
            break;
         case DT_U_CHAR:
         case DT_BYTE:
            retval.value.lnum = from_eval1.value.lnum % from_eval2.value.ucnum;
            break;
         case DT_SHORT:
            retval.value.lnum = from_eval1.value.lnum % from_eval2.value.shnum;
            break;
         case DT_U_SHORT:
            retval.value.lnum = from_eval1.value.lnum % from_eval2.value.ushnum;
            break;
         case DT_INT:
            retval.value.lnum = from_eval1.value.lnum % from_eval2.value.inum;
            break;
         case DT_U_INT:
            retval.value.lnum = from_eval1.value.lnum % from_eval2.value.uinum;
            break;
         case DT_LONG:
            retval.value.lnum = from_eval1.value.lnum % from_eval2.value.lnum;
            break;
         case DT_U_LONG:
            retval.value.lnum = from_eval1.value.lnum % from_eval2.value.ulnum;
            break;
         case DT_LONG_LONG:
            retval.value.lnum = from_eval1.value.lnum % from_eval2.value.llnum;
            break;
         case DT_U_LONG_LONG:
            retval.value.lnum = from_eval1.value.lnum % from_eval2.value.ullnum;
            break;
         case DT_SIZE_T:
            retval.value.lnum = from_eval1.value.lnum % from_eval2.value.stnum;
            break;
         default:
            break;
         }
      ...
      case DT_U_INT:
         ...
         {
         case DT_CHAR:
            retval.value.uinum = from_eval1.value.uinum % from_eval2.value.cnum;
            break;
         case DT_S_CHAR:
            retval.value.uinum = from_eval1.value.uinum % from_eval2.value.scnum;
            break;
         case DT_U_CHAR:
         case DT_BYTE:
            retval.value.uinum = from_eval1.value.uinum % from_eval2.value.ucnum;
            break;
         case DT_SHORT:
            retval.value.uinum = from_eval1.value.uinum % from_eval2.value.shnum;
            break;
         case DT_U_SHORT:
            retval.value.uinum = from_eval1.value.uinum % from_eval2.value.ushnum;
            break;
         case DT_INT:
            retval.value.uinum = from_eval1.value.uinum % from_eval2.value.inum;
            break;
         case DT_U_INT:
            retval.value.uinum = from_eval1.value.uinum % from_eval2.value.uinum;
            break;
         case DT_LONG:
            retval.value.uinum = from_eval1.value.uinum % from_eval2.value.lnum;
            break;
         case DT_U_LONG:
            retval.value.uinum = from_eval1.value.uinum % from_eval2.value.ulnum;
            break;
         case DT_LONG_LONG:
            retval.value.uinum = from_eval1.value.uinum % from_eval2.value.llnum;
            break;
         case DT_U_LONG_LONG:
            retval.value.uinum = from_eval1.value.uinum % from_eval2.value.ullnum;
            break;
         case DT_SIZE_T:
            retval.value.uinum = from_eval1.value.uinum % from_eval2.value.stnum;
            break;
         default:
            break;
         }
      ...
      case DT_INT:
         ...
         {
         case DT_CHAR:
            retval.value.inum = from_eval1.value.inum % from_eval2.value.cnum;
            break;
         case DT_S_CHAR:
            retval.value.inum = from_eval1.value.inum % from_eval2.value.scnum;
            break;
         case DT_U_CHAR:
         case DT_BYTE:
            retval.value.inum = from_eval1.value.inum % from_eval2.value.ucnum;
            break;
         case DT_SHORT:
            retval.value.inum = from_eval1.value.inum % from_eval2.value.shnum;
            break;
         case DT_U_SHORT:
            retval.value.inum = from_eval1.value.inum % from_eval2.value.ushnum;
            break;
         case DT_INT:
            retval.value.inum = from_eval1.value.inum % from_eval2.value.inum;
            break;
         case DT_U_INT:
            retval.value.inum = from_eval1.value.inum % from_eval2.value.uinum;
            break;
         case DT_LONG:
            retval.value.inum = from_eval1.value.inum % from_eval2.value.lnum;
            break;
         case DT_U_LONG:
            retval.value.inum = from_eval1.value.inum % from_eval2.value.ulnum;
            break;
         case DT_LONG_LONG:
            retval.value.inum = from_eval1.value.inum % from_eval2.value.llnum;
            break;
         case DT_U_LONG_LONG:
            retval.value.inum = from_eval1.value.inum % from_eval2.value.ullnum;
            break;
         case DT_SIZE_T:
            retval.value.inum = from_eval1.value.inum % from_eval2.value.stnum;
            break;
         default:
            break;
         }
      ...
      case DT_U_SHORT:
         ...
         {
         case DT_CHAR:
            retval.value.ushnum = from_eval1.value.ushnum % from_eval2.value.cnum;
            break;
         case DT_S_CHAR:
            retval.value.ushnum = from_eval1.value.ushnum % from_eval2.value.scnum;
            break;
         case DT_U_CHAR:
         case DT_BYTE:
            retval.value.ushnum = from_eval1.value.ushnum % from_eval2.value.ucnum;
            break;
         case DT_SHORT:
            retval.value.ushnum = from_eval1.value.ushnum % from_eval2.value.shnum;
            break;
         case DT_U_SHORT:
            retval.value.ushnum = from_eval1.value.ushnum % from_eval2.value.ushnum;
            break;
         case DT_INT:
            retval.value.ushnum = from_eval1.value.ushnum % from_eval2.value.inum;
            break;
         case DT_U_INT:
            retval.value.ushnum = from_eval1.value.ushnum % from_eval2.value.uinum;
            break;
         case DT_LONG:
            retval.value.ushnum = from_eval1.value.ushnum % from_eval2.value.lnum;
            break;
         case DT_U_LONG:
            retval.value.ushnum = from_eval1.value.ushnum % from_eval2.value.ulnum;
            break;
         case DT_LONG_LONG:
            retval.value.ushnum = from_eval1.value.ushnum % from_eval2.value.llnum;
            break;
         case DT_U_LONG_LONG:
            retval.value.ushnum = from_eval1.value.ushnum % from_eval2.value.ullnum;
            break;
         case DT_SIZE_T:
            retval.value.ushnum = from_eval1.value.ushnum % from_eval2.value.stnum;
            break;
         default:
            break;
         }
      ...
      case DT_SHORT:
         ...
         {
         case DT_CHAR:
            retval.value.shnum = from_eval1.value.shnum % from_eval2.value.cnum;
            break;
         case DT_S_CHAR:
            retval.value.shnum = from_eval1.value.shnum % from_eval2.value.scnum;
            break;
         case DT_U_CHAR:
         case DT_BYTE:
            retval.value.shnum = from_eval1.value.shnum % from_eval2.value.ucnum;
            break;
         case DT_SHORT:
            retval.value.shnum = from_eval1.value.shnum % from_eval2.value.shnum;
            break;
         case DT_U_SHORT:
            retval.value.shnum = from_eval1.value.shnum % from_eval2.value.ushnum;
            break;
         case DT_INT:
            retval.value.shnum = from_eval1.value.shnum % from_eval2.value.inum;
            break;
         case DT_U_INT:
            retval.value.shnum = from_eval1.value.shnum % from_eval2.value.uinum;
            break;
         case DT_LONG:
            retval.value.shnum = from_eval1.value.shnum % from_eval2.value.lnum;
            break;
         case DT_U_LONG:
            retval.value.shnum = from_eval1.value.shnum % from_eval2.value.ulnum;
            break;
         case DT_LONG_LONG:
            retval.value.shnum = from_eval1.value.shnum % from_eval2.value.llnum;
            break;
         case DT_U_LONG_LONG:
            retval.value.shnum = from_eval1.value.shnum % from_eval2.value.ullnum;
            break;
         case DT_SIZE_T:
            retval.value.shnum = from_eval1.value.shnum % from_eval2.value.stnum;
            break;
         default:
            break;
         }
      ...
      case DT_U_CHAR:
         ...
         {
         case DT_CHAR:
            retval.value.ucnum = from_eval1.value.ucnum % from_eval2.value.cnum;
            break;
         case DT_S_CHAR:
            retval.value.ucnum = from_eval1.value.ucnum % from_eval2.value.scnum;
            break;
         case DT_U_CHAR:
         case DT_BYTE:
            retval.value.ucnum = from_eval1.value.ucnum % from_eval2.value.ucnum;
            break;
         case DT_SHORT:
            retval.value.ucnum = from_eval1.value.ucnum % from_eval2.value.shnum;
            break;
         case DT_U_SHORT:
            retval.value.ucnum = from_eval1.value.ucnum % from_eval2.value.ushnum;
            break;
         case DT_INT:
            retval.value.ucnum = from_eval1.value.ucnum % from_eval2.value.inum;
            break;
         case DT_U_INT:
            retval.value.ucnum = from_eval1.value.ucnum % from_eval2.value.uinum;
            break;
         case DT_LONG:
            retval.value.ucnum = from_eval1.value.ucnum % from_eval2.value.lnum;
            break;
         case DT_U_LONG:
            retval.value.ucnum = from_eval1.value.ucnum % from_eval2.value.ulnum;
            break;
         case DT_LONG_LONG:
            retval.value.ucnum = from_eval1.value.ucnum % from_eval2.value.llnum;
            break;
         case DT_U_LONG_LONG:
            retval.value.ucnum = from_eval1.value.ucnum % from_eval2.value.ullnum;
            break;
         case DT_SIZE_T:
            retval.value.ucnum = from_eval1.value.ucnum % from_eval2.value.stnum;
            break;
         default:
            break;
         }
      ...
      case DT_S_CHAR:
         ...
         {
         case DT_CHAR:
            retval.value.scnum = from_eval1.value.scnum % from_eval2.value.cnum;
            break;
         case DT_S_CHAR:
            retval.value.scnum = from_eval1.value.scnum % from_eval2.value.scnum;
            break;
         case DT_U_CHAR:
         case DT_BYTE:
            retval.value.scnum = from_eval1.value.scnum % from_eval2.value.ucnum;
            break;
         case DT_SHORT:
            retval.value.scnum = from_eval1.value.scnum % from_eval2.value.shnum;
            break;
         case DT_U_SHORT:
            retval.value.scnum = from_eval1.value.scnum % from_eval2.value.ushnum;
            break;
         case DT_INT:
            retval.value.scnum = from_eval1.value.scnum % from_eval2.value.inum;
            break;
         case DT_U_INT:
            retval.value.scnum = from_eval1.value.scnum % from_eval2.value.uinum;
            break;
         case DT_LONG:
            retval.value.scnum = from_eval1.value.scnum % from_eval2.value.lnum;
            break;
         case DT_U_LONG:
            retval.value.scnum = from_eval1.value.scnum % from_eval2.value.ulnum;
            break;
         case DT_LONG_LONG:
            retval.value.scnum = from_eval1.value.scnum % from_eval2.value.llnum;
            break;
         case DT_U_LONG_LONG:
            retval.value.scnum = from_eval1.value.scnum % from_eval2.value.ullnum;
            break;
         case DT_SIZE_T:
            retval.value.scnum = from_eval1.value.scnum % from_eval2.value.stnum;
            break;
         default:
            break;
         }
      ...
      case DT_CHAR:
         ...
         {
         case DT_CHAR:
            retval.value.cnum = from_eval1.value.cnum % from_eval2.value.cnum;
            break;
         case DT_S_CHAR:
            retval.value.cnum = from_eval1.value.cnum % from_eval2.value.scnum;
            break;
         case DT_U_CHAR:
         case DT_BYTE:
            retval.value.cnum = from_eval1.value.cnum % from_eval2.value.ucnum;
            break;
         case DT_SHORT:
            retval.value.cnum = from_eval1.value.cnum % from_eval2.value.shnum;
            break;
         case DT_U_SHORT:
            retval.value.cnum = from_eval1.value.cnum % from_eval2.value.ushnum;
            break;
         case DT_INT:
            retval.value.cnum = from_eval1.value.cnum % from_eval2.value.inum;
            break;
         case DT_U_INT:
            retval.value.cnum = from_eval1.value.cnum % from_eval2.value.uinum;
            break;
         case DT_LONG:
            retval.value.cnum = from_eval1.value.cnum % from_eval2.value.lnum;
            break;
         case DT_U_LONG:
            retval.value.cnum = from_eval1.value.cnum % from_eval2.value.ulnum;
            break;
         case DT_LONG_LONG:
            retval.value.cnum = from_eval1.value.cnum % from_eval2.value.llnum;
            break;
         case DT_U_LONG_LONG:
            retval.value.cnum = from_eval1.value.cnum % from_eval2.value.ullnum;
            break;
         case DT_SIZE_T:
            retval.value.cnum = from_eval1.value.cnum % from_eval2.value.stnum;
            break;
         default:
            break;
         }
   ...
   default:
      fatal_error("Error: Unknown operator in eval_math_oper.");
   }
...
data eval_mknode(node* to_eval)
{
   ...
   if (!dest.value.ptr->childset)
      fatal_error("Lack of memory in mknode.");
...
data eval_rmnode(node* to_eval)
{
   ...
   if (!list.value.ptr->childset)
      fatal_error("Lack of memory in rmnode.");
...
data eval_value(node* to_eval)
{
   ...
   else if (from_eval.value.ptr->ntype == NT_STRING)
   {
      ...
      if (!retval.value.str.tab)
         fatal_error("Error: Lack of memory in eval_value.");
      g_lst_add(retval.value.str.tab, PT_CHAR_TAB);
...
data eval_getwd(void)
{
   ...
   if (!retval.value.str.tab)
      fatal_error("Error: Lack ok memory in eval_getwd for string data.");
   g_lst_add(retval.value.str.tab, PT_CHAR_TAB);
...
data eval_tonode(node* to_eval)
{
   ...
   if (!npt) fatal_error("Error: Lack of memory in eval_tonode for new node.");
   ...
   if (from_eval.ti.dtype == DT_STRING)
   {
      ...
      if (!npt->opval.str.tab)
         fatal_error("Error: Lack of memory in eval_tonode for new string.");
...
data eval_subseq(node* to_eval)
{
   ...
   if (seq.ti.dtype == DT_POINTER)
   {
      ...
      if (!npt) fatal_error("Error: Lack of memory in eval_subseq for new node.");
      memset(npt, 0, sizeof(node));
      g_lst_add(npt, PT_NODE);
      npt->ntype = NT_LIST;
      ...
      if (!npt->childset)
         fatal_error("Error: Lack of memory in eval_subseq for subnodes.");
   ...
   else if (seq.ti.dtype == DT_STRING)
   {
      ...
      if (!str) fatal_error("Error: Lack of memory in subseq for new string data.");
      memset(str, 0, len + 1);
   ...
   else if (seq.ti.dtype == DT_ARRAY)
   {
      ...
      if (!parr) fatal_error("Error: Lack of memory in subseq for new array struct.");
      memset(parr, 0, sizeof(array));
      g_lst_add(parr, PT_ARRAY);
      parr->length = len;
      parr->dtable = malloc(len * sizeof(data));
      if (!parr->dtable)
         fatal_error("Error: Lack of memory in subseq for new array data.");
   ...
   else if (seq.ti.dtype == DT_LIST)
   {
      ...
      if (!plst) fatal_error("Error: Lack of memory in subseq for new list struct.");
      ...
      for (i = lstart; i <= lend; i++)
      {
         *destination = malloc(sizeof(listlink));
         if (!*destination)
            fatal_error("Error: Lack of memory in subseq for new link.");
...
data eval_concat(node* to_eval)
{
   ...
   if (!data_tab) fatal_error("Error: Lack of memory in eval_concat for data_tab.");
   ...
   if (data_tab[0].ti.dtype == DT_POINTER)
   {
      ...
      npt = malloc(sizeof(node));
      if (!npt) fatal_error("Error: Lack of memory in eval_concat for new node.");
      memset(npt, 0, sizeof(node));
      g_lst_add(npt, PT_NODE);
      npt->ntype = NT_LIST;
      npt->opval.str.length = 0;
      ...
      npt->childset = malloc(len * sizeof(node*));
      if (!npt->childset)
         fatal_error("Error: Lack of memory in eval_concat for subnodes.");
      memset(npt->childset, 0, len * sizeof(node*));
   ...
   else if (data_tab[0].ti.dtype == DT_ARRAY)
   {
      ...
      parr = malloc(sizeof(array));
      if (!parr) fatal_error("Error: Lack of memory in concat for new array struct.");
      memset(parr, 0, sizeof(array));
      g_lst_add(parr, PT_ARRAY);
      parr->length = len;
      parr->dtable = malloc(len * sizeof(data));
      if (!parr->dtable)
         fatal_error("Error: Lack of memory in concat for new array content.");
      memset(parr->dtable, 0, len * sizeof(data));
   ...
   else if (data_tab[0].ti.dtype == DT_LIST)
   {
      ...
      if (!plst) fatal_error("Error: Lack of memory in concat for new list struct.");
      memset(plst, 0, sizeof(list));
      g_lst_add(plst, PT_LIST);
      plst->length = len;
      ...
      for (i = 0; i < len; i++)
      {
         *destination = malloc(sizeof(listlink));
         if (!*destination)
            fatal_error("Error: Lack of memory in concat for chain link.");
         memset(*destination, 0, sizeof(listlink));
         destination = &(*destination)->next;
      }
      *destination = NULL;
   ...
   else if (data_tab[0].ti.dtype == DT_STRING)
   {
      ...
      str = malloc(len + 1);
      if (!str) fatal_error("Error: Lack of memory in concat for new string data.");
      memset(str, 0, len + 1);
      g_lst_add(str, PT_CHAR_TAB);
...
data eval_ntoa(node* to_eval)
{
   ...
   retval.value.str.tab = malloc(retval.value.str.length);
   if (!retval.value.str.tab)
      fatal_error("Error: Lack of memory in ntoa.");
...
data eval_names(node* to_eval)
{
   ...
   if (!from_eval) fatal_error("Error : Lack of memory in names for results table.");
   ...
   retval.value.pObject = malloc(sizeof(clos_set));
   if (!retval.value.pObject)
      fatal_error("Error : Lack of memory in names for new object.");
   memset(retval.value.pObject, 0, sizeof(clos_set));
   g_lst_add(retval.value.pObject, PT_OBJECT);

   retval.value.pObject->clos_array = malloc(arg * sizeof(closure*));
   if (!retval.value.pObject->clos_array)
      fatal_error("Error : Lack of memory in names for new member array.");
   ...
   for (arg = 0; arg < to_eval->nb_children; arg++)
   {
      ...
      if (!retval.value.pObject->clos_array[arg])
         fatal_error("Error : Lack of memory in names for new member.");
      ...
      if (!retval.value.pObject->clos_array[arg]->name)
         fatal_error("Error : Lack of memory in names for new member name.");
...
data eval_array(node* to_eval)
{
   ...
   pArr = malloc(sizeof(array));
   if (!pArr) fatal_error("Error: Lack of memory in eval_array for array.");
   memset(pArr, 0, sizeof(array));
   g_lst_add(pArr, PT_ARRAY);
   ...
   if (!pArr->dtable)
      fatal_error("Error: Lack of memory in eval_array for data table.");
...
data eval_list(node* to_eval)
{
   ...
   plst = malloc(sizeof(list));
   if (!plst) fatal_error("Error: Lack of memory in eval_list for list.");
   memset(plst, 0, sizeof(list));
   g_lst_add(plst, PT_LIST);
   ...
   for (arg = 0; arg < to_eval->nb_children; arg++)
   {
      *destination = malloc(sizeof(listlink));
      if (!*destination)
         fatal_error("Error: Lack of memory in eval_list for link.");
      memset(*destination, 0, sizeof(listlink));
...
{
   int err = 0;
   data retval, from_eval, * from_resolve = NULL;
   clos_set* pobj = NULL;
   size_t nIter = 0, i = 0;
   ...
   if (!from_resolve)
   {
      yyerror("Error: Unresolved first argument of fillobject function.");
      abort_called = 1;
      return retval;
   }

   if (from_resolve->ti.dtype != DT_OBJECT)
   {
   ...
   pobj = from_resolve->value.pObject;
   ...
   if (pdest->ti.dtype == DT_ARRAY)
   {
      ...
      if (oldlen < llength)
      {
         ...
         if (!pdest->value.pArray->dtable)
            fatal_error("Error: Lack of memory in setlength for greater array.");
      ...
      else
      {
         ...
         pdest->value.pArray->dtable = realloc(pdest->value.pArray->dtable, 
            llength * sizeof(data));
         if (!pdest->value.pArray->dtable)
            fatal_error("Error: Lack of memory in setlength for smaller array.");
   ...
   else if (pdest->ti.dtype == DT_LIST)
   {
      ...
      if (oldlen < llength)
      {
         ...
         for (i = oldlen; i < llength; i++)
         {
            *destination = malloc(sizeof(listlink));
            if (!*destination)
               fatal_error("Error: Lack of emmory in setlength for new link.");
            memset(*destination, 0, sizeof(listlink));
            destination = &(*destination)->next;
         }
      }
   ...
   else if (pdest->ti.dtype == DT_STRING || pdest->ti.dtype == DT_MEMORY)
   {
      ...
      if (oldlen < llength)
      {
         ...
         if (!pdest->value.str.tab)
            fatal_error("Error: Lack of memory in setlength for longer string.");
      ...
      else
      {
         ...
         pdest->value.str.tab = realloc(pdest->value.str.tab, llength);
         if (!pdest->value.str.tab)
            fatal_error("Error: Lack of memory in setlength for shorter string.");
         g_lst_add(pdest->value.str.tab, PT_CHAR_TAB);
         pdest->value.str.tab[llength - 1] = '\0';
      }
   }
   else if (pdest->ti.dtype == DT_POINTER)
   {
      ...
      if (oldlen < llength)
      {
         ...
         if (!pdest->value.ptr->childset)
            fatal_error("Error: Lack of memory in setlength "
               "for new statements list.");
         for (i = oldlen; i < llength; i++)
         {
            node* npt = malloc(sizeof(node));
            if (!npt)
               fatal_error("Error: Lack of memory in setlength for new node.");
            memset(npt, 0, sizeof(node));
            npt->ntype = NT_NUM_CONST;
            npt->opval.value = 0.0;
      ...
      else
      {
         ...
         pdest->value.ptr->childset = realloc(pdest->value.ptr->childset, 
            llength * sizeof(node*));
         if (!pdest->value.ptr->childset)
            fatal_error("Error: Lack of memory in setlength for shorter "
               "statements list.");
      }
   }
   else
...
data eval_insert(node* to_eval)
{
   ...
   if (pdest->ti.dtype == DT_STRING)
   {
      ...
      pdest->value.str.tab = realloc(pdest->value.str.tab, oldlen + 
         addlen);
      if (!pdest->value.str.tab)
         fatal_error("Error: Lack of memory in insert for new string.");
      g_lst_add(pdest->value.str.tab, PT_CHAR_TAB);
   ...
   else if (pdest->ti.dtype == DT_ARRAY)
   {
      ...
      if (!pdest->value.pArray->dtable)
         fatal_error("Error: Lack of memory in insert for new array.");
   ...
   else /* pdest->ti.dtype == DT_POINTER */
   {
      ...
      pdest->value.ptr->childset = realloc(pdest->value.ptr->childset, (oldlen 
         + addlen) * sizeof(node*));
      if (!pdest->value.ptr->childset)
         fatal_error("Error: Lack of memory in insert for new list.");
...
data eval_as_array(node* to_eval)
{
   ...
   if (from_eval.ti.dtype == DT_POINTER)
   {
      ...
      parr = malloc(sizeof(array));
      if (!parr)
         fatal_error("Error: Lack of memory in as_array for array struct.");
      memset(parr, 0, sizeof(array));
      g_lst_add(parr, PT_ARRAY);
      retval.ti.dtype = DT_ARRAY;
      ...
      parr->dtable = malloc(parr->length * sizeof(data));
      if (!parr->dtable)
         fatal_error("Error: Lack of memory in as_array for array data.");
      memset(parr->dtable, 0, parr->length * sizeof(data));
      ...
      for (i = 0; i < parr->length; i++)
      {
         ...
         if (from_eval.value.ptr->childset[i]->ntype == NT_STRING)
         {
            ...
            if (!parr->dtable[i].value.str.tab)
               fatal_error("Error: Lack of memory in as_array for string data.");
   ...
   else if (from_eval.ti.dtype == DT_LIST)
   {
      ...
      parr = malloc(sizeof(array));
      if (!parr) fatal_error("Error: Lack of memory in as_array for array struct.");
      memset(parr, 0, sizeof(array));
      g_lst_add(parr, PT_ARRAY);
      retval.ti.dtype = DT_ARRAY;
...
data eval_as_list(node* to_eval)
{
   ...
   if (from_eval.ti.dtype == DT_POINTER)
   {
      ...
      plst = malloc(sizeof(list));
      if (!plst)
         fatal_error("Error: Lack of memory in as_list for list struct.");
      memset(plst, 0, sizeof(list));
      g_lst_add(plst, PT_LIST);
      ...
      for (i = 0; i < plst->length; i++)
      {
         *destination = malloc(sizeof(listlink));
         if (!*destination)
            fatal_error("Error: Lack of memory in as_list for list link.");
         memset(*destination, 0, sizeof(listlink));
         if (!from_eval.value.ptr->childset[i])
         {
         ...
         if (from_eval.value.ptr->childset[i]->ntype == NT_STRING)
         {
            ...
            if (!str.tab)
               fatal_error("Error: Lack of memory is as_list for string data.");
...
data eval_as_statements(node* to_eval)
{
   ...
   if (from_eval.ti.dtype == DT_ARRAY)
   {
      npt = malloc(sizeof(node));
      if (!npt)
         fatal_error("Error: Lack of memory in as_statements for statements list"
            " node.");
      memset(npt, 0, sizeof(node));
      g_lst_add(npt, PT_NODE);
      npt->ntype = NT_LIST;
      ...
      if (!npt->childset)
         fatal_error("Error: Lack of memory in as_statements for node array.");
      ...
      for (i = 0; i < npt->nb_children; i++)
      {
            ...
            from_eval.value.pArray->dtable[i].ti.dtype <= DT_LONG_DOUBLE)
         {
            ...
            if (!npt->childset[i])
               fatal_error("Error: Lack of memory in as_statements for data node");
         ...
         else if (from_eval.value.pArray->dtable[i].ti.dtype == DT_STRING)
         {
            ...
            str = malloc(len);
            if (!str)
               fatal_error("Error: Lack of memory in as_statements for string"
                  " data.");
         ...
         else
         {
            npt->childset[i] = malloc(sizeof(node));
            if (!npt->childset[i])
               fatal_error("Error: Lack of memory in as_statements for zero node");
            memset(npt->childset[i], 0, sizeof(node));
            npt->childset[i]->ntype = NT_NUM_CONST;
...
data eval_gettype(node* to_eval)
{
   ...
   case DT_MEMADR:
      ...
      break;
   default:
      fatal_error("Error: Unexpected data type in gettype.");
   }
   ...
   if (!retval.value.str.tab)
      fatal_error("Error: Lack of memory in gettype for string data.");
...
data eval_fgetpos(node* to_eval)
{
   ...
   if (arg2->ti.dtype != DT_PFPOS_T || arg2->ti.nderef > 0)
   {
      ...
      if (!arg2->value.pfpos)
         fatal_error("Error: Lack of memory in fgetpos for fpos_t.");
...
data eval_fgetc(node* to_eval)
{
   ...
   retval.ti.dtype = DT_INT;
   retval.value.inum = fgetc(from_eval.value.pfile);
...
data eval_fputc(node* to_eval)
{
   ...
   retval.value.str.tab = malloc(2);
   if (!retval.value.str.tab)
      fatal_error("Error: Lack of memory in eval_fputc for new string.");
  ...
  /* Arguments verification. */
   ...
   if (symbol->ti.dtype == DT_STRING)
   {
      ...
      if (!symbol->value.str.tab)
         fatal_error("Error: Lack of memory in remove for new string.");
   ...
   else if (symbol->ti.dtype == DT_ARRAY)
   {
      ...
      if (!symbol->value.pArray->dtable)
         fatal_error("Error: Lack of memory in remove for new array.");
   ...
   else /* symbol->ti.dtype == DT_POINTER */
   {
      ...
      if (!symbol->value.ptr->childset)
         fatal_error("Error: Lack of memory in remove for new child set.");
...
data eval_atovar(node* to_eval)
{
   ...
   /* Node creation. */
   npt = malloc(sizeof(node));
   if (!npt) fatal_error("Error: Lack of memory in eval_atovar for new node.");
   memset(npt, 0, sizeof(node));
   g_lst_add(npt, PT_NODE);
   ...
   if (!npt->opval.name)
      fatal_error("Error: Lack of memory in eval_atovar for name string.");
...
data eval_vartoa(node* to_eval)
{
   ...
   if (!retval.value.str.tab)
      fatal_error("Error: Lack of memory in eval_vartoa for string return value.");
...
data eval_strclone(node* to_eval)
{
   ...
   if (!retval.value.str.tab)
      fatal_error("Error: Lack of memory in eval_strclone for new string.");
...
data eval_alloc_copy(node* to_eval)
{
   ...
   if (!pdat) fatal_error("Error: Lack of memory in alloc_copy for new data.");
...
data eval_repeat(node* to_eval)
{
   ...
   if (!retval.value.pArray)
      fatal_error("Error: Lack of memory for array structure in repeat.");
   ...
   if (!retval.value.pArray->dtable)
      fatal_error("Error: Lack of memory for array data in repeat.");
...
size_t buffersize(data var, size_t* alignpt)
{
   ...
   else
   {
      ...
      case DT_LIST:
         ...
         return 0;
      default:
         fatal_error("Error: Unexpected variable type in buffersize.");
      }
   }
...
void fillbuffer(data var, char* buffer, size_t offset)
{
   ...
   else
   {
      ...
      case DT_ARRAY:
         ...
         return;
      default:
         fatal_error("Error: Unexpected variable type in fillbuffer.");
      }
   }
}
...
data eval_vartomem(node* to_eval)
{
   ...
   if (!retval.value.mem.tab)
      fatal_error("Error: Lack of memory in vartomem for buffer.");
...
void readbuffer(data* var, char* buffer, size_t offset)
{
   ...
   else
   {
      ...
      case DT_ARRAY:
         ...
         return;
      default:
         fatal_error("Error: Unexpected variable type in readbuffer.");
      }
   }
}
...
data eval_memclone(node* to_eval)
{
   ...
   if (!retval.value.mem.tab)
      fatal_error("Error: Lack of memory in memclone.");
...
data eval_memory(node* to_eval)
{
   ...
   if (!retval.value.mem.tab)
      fatal_error("Error: Lack of memory in memory function.");
...
data eval_createnode(node* to_eval)
{
   ...
   case NT_MATH_OPER:
      ...
      if (from_eval.value.cnum != '-' && from_eval.value.cnum != '+' && from_eval.value.cnum != '*'  && 
         ...
         from_eval.value.cnum != '&' && from_eval.value.cnum != '%')
      {
...
data eval_detachnode(node* to_eval)
{
   int err = 0;
   data retval, from_eval;
   node* argparent = NULL;
   ...
   if (err)
   {
      yyerror("Error: Wrong number of arguments in detachnode.");
      yyerror("       This function has two parameters.");
      abort_called = 1;
      return retval;
   }
   ...
   from_eval = eval(to_eval->childset[0]);
   if (from_eval.ti.dtype != DT_POINTER || from_eval.ti.nderef || !from_eval.value.ptr)
   {
      yyerror("Error: First argument of detachnode has to be a node pointer.");
      abort_called = 1;
      free_data(from_eval);
      return retval;
   }
   argparent = from_eval.value.ptr;

   from_eval = eval(to_eval->childset[1]);
   if (from_eval.ti.dtype < DT_CHAR || from_eval.ti.dtype > DT_LONG_DOUBLE ||
      from_eval.ti.nderef)
   {
      yyerror("Error: Second argument type of detachnode is not numeric.");
      abort_called = 1;
      free_data(from_eval);
      return retval;
   }
   ...
   retval.ti.dtype = DT_POINTER;
   retval.value.ptr = argparent->childset[lpos];
...
data eval_swapnodes(node* to_eval)
{
   int err = 0;
   data retval, from_eval;
   node* parent1 = NULL, * parent2 = NULL, * temp = NULL;
   size_t lpos1 = 0, lpos2 = 0;
   ...
   if (err)
   {
      yyerror("Error: Wrong number of arguments in swapnodes.");
      yyerror("       This function has four parameters.");
      abort_called = 1;
      return retval;
   }
   ...
   if (from_eval.ti.dtype != DT_POINTER || from_eval.ti.nderef || !from_eval.value.ptr)
   {
      yyerror("Error: First argument of swapnodes has to be a node pointer.");
      abort_called = 1;
      free_data(from_eval);
      return retval;
   }
   parent1 = from_eval.value.ptr;

   from_eval = eval(to_eval->childset[1]);
   if (from_eval.ti.dtype < DT_CHAR || from_eval.ti.dtype > DT_LONG_DOUBLE ||
      from_eval.ti.nderef)
   {
      yyerror("Error: Second argument type of swapnodes is not numeric.");
      abort_called = 1;
      free_data(from_eval);
      return retval;
   }
   ...
   if (from_eval.ti.dtype != DT_POINTER || from_eval.ti.nderef || !from_eval.value.ptr)
   {
      yyerror("Error: Third argument of swapnodes has to be a node pointer.");
      abort_called = 1;
      free_data(from_eval);
      return retval;
   }
   parent2 = from_eval.value.ptr;

   from_eval = eval(to_eval->childset[3]);
   if (from_eval.ti.dtype < DT_CHAR || from_eval.ti.dtype > DT_LONG_DOUBLE ||
      from_eval.ti.nderef)
   {
      yyerror("Error: Fourth argument type of swapnodes is not numeric.");
      abort_called = 1;
      free_data(from_eval);
      return retval;
   }
   ...
   if (parent1 == parent2 && lpos1 == lpos2) return retval;

   temp = parent1->childset[lpos1];
   parent1->childset[lpos1] = parent2->childset[lpos2];
   parent1->childset[lpos1]->parent = parent1;
   temp->parent = parent2;
   parent2->childset[lpos2] = temp;
...
data eval_func_call(node* to_eval)
{
   ...
   else if (to_eval->childset[0]->ntype == NT_ACCESSLIST)
   {
      ...
      {
         fatal_error("Error: Unknown cont_type in eval_func_call.");
      }
   }
   else
   {
   ...
   if (!data_tab)
      fatal_error("Error: Lack of memory for data_tab in eval_func_call.");
   ...
   if (!clos_set_stack[set_stack_size-1]->clos_array)
      fatal_error("Error: Lack of memory for\n"
         "clos_array in eval_func_call.");
   ...
   for (i = 0; i < nb_param; i++)
   {
      ...
      if (func_pt->childset[0]->childset[i]->ntype != NT_VARIABLE)
         fatal_error("Error: Encountered a non variable parameter.");
      ...
      if(!clos_set_stack[set_stack_size-1]->clos_array[i + nb_members]->name)
         fatal_error("Error: Lack of memory for a name in eval_func_call.");
...
data eval_dotlist(node* start_pt, node* dotlist)
{
   ...
   while (i < dotlist->nb_children)
   {
      ...
      else fatal_error("Error: Unknown node type in eval_dotlist.");
      i++;
   }
...
data eval_subscript(node* to_eval)
{
   ...
   if ((from_eval.ti.dtype != DT_ARRAY && from_eval.ti.dtype != DT_LIST && 
      from_eval.ti.dtype != DT_STRING && from_eval.ti.dtype != DT_MEMORY) || from_eval.ti.nderef)
   {
...
data eval(node* to_eval)
{
   ...
   case NT_STRING:
      ...
      if (!retval.value.str.tab)
         fatal_error("Error: Lack of memory for a string in eval.");
   ...
   default:
      fatal_error("Error: Unknown node type in eval.");
   }
